...
export default data = [
...

    {
        id:1818508,
        vote_average:7.2,
        title:"The Big Bang Theory - les Nerd",
        poster_path:"",
        original_title:"American Sitcom",
...

     {
        id:1081808,
        vote_average:7.2,
        title:"Black peace and love",
        poster_path:"",
        original_title:"Le vrai film de la nouvelle generation",
        overview:"Vennez tous regarder Les héros du Réveil de la force rejoignent les figures légendaires de la galaxie dans une aventure épique qui révèle des secrets ancestraux sur la Force et entraîne de choquantes révélations sur le passé…",
